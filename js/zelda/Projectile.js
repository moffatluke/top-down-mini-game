...
class ZeldaProjectile {
    ...
    checkWallCollision(gameMap) {
        const tileX = Math.floor(this.x / gameMap.tileSize);
        const tileY = Math.floor(this.y / gameMap.tileSize);
        const tileType = gameMap.getTile(tileX, tileY);
        
        return gameMap.isSolid(tileType);
    }
